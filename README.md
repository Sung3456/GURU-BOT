...
3.[![Deploy on Heroku](https://www.heroku.com/deploy/button.svg)](https://dashboard.heroku.com/new?template=https://github.com/Sung3456/GURU-BOT/tree/main?tab=readme-ov-file)
```
